...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, line):
        ...
        if args[0] in self.classes:
            ...
            for arg in args[1:]:  # start from index 1
                if '=' in arg:
    ...
    def help_create(self):
        ...
        print("[Usage]: create <className> [<attributes>]\n")
    ...
    def do_destroy(self, args):
        ...
        try:
            obj = storage.all()[key]
            storage.delete(obj)  # use delete from storage
    ...
    def do_count(self, args):
        ...
        count = sum(1 for k in storage.all(args) if k.split('.')[0] == args)
        print(count)
    ...
    def do_update(self, args):
        ...
        for arg in args:
            if '=' in arg:
                att_name, att_val = arg.split('=', 1)
                att_val = att_val.strip().strip('"').replace('_', ' ')
    ...
    def help_update(self):
        ...
        print("OR: update <class_name> <id> <dictionary representation>\n")
